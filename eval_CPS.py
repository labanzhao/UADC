...
def get_args(known=False):
    ...
    parser.add_argument('--model_weights', type=str, default='student11_best.pth', help='model weights')
...
def eval(is_debug=False):
    args = get_args()
    # Project Saving Path
    project_path = args.project + '_{}_label_{}_cps/'.format(args.backbone, args.labeled_percentage)
    # Load Data
