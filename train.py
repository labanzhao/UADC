...
def get_args(known=False):
    ...
    parser.add_argument('--topk', type=float, default=1, help='top k')
...
#更改部分####################################################################################################################
            ...
            pred22 = model2(image_dct, ([256, 256]))#[4,2,256,256]
            # print(image_dct.shape)#[4 64 64 64]
            # print("22222222222222222222222222222222222222222222222222222222222222")
            # print(pred22.shape)#[4 2 256 256]
            # return 0
            # pred22 = model2(image)
            pred22_feature = torch.softmax(pred22, dim=1)
            # print(label.shape) #[4 1 256 256]
            # print("#######################################")
            # print(pred11.shape) #[4 2 256 256]
...
#无cmt的训练################################################################################################################
            ...
            with torch.no_grad():
                ...
                image2 = folds(img_unfold.view(B, C*h*w, -1))        #[4 3 256 256]
            ...
            # pred22_u_stage2 = model2(uimage2)
